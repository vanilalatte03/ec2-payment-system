...
INSERT INTO order_items (
    ...
    (10001, 10001, 10003, '오버핏 코튼 크루넥 티셔츠', 39000, 2, NOW(), NOW()),
    (10002, 10002, 10006, '램스울 오버사이즈 니트', 89000, 1, NOW(), NOW()),
    (10003, 10003, 10002, '베이직 스트라이프 삭스 3팩', 6900, 1, NOW(), NOW()),
    (10004, 10003, 10011, '스트레치 슬림 치노팬츠', 48000, 1, NOW(), NOW()),
    (10005, 10003, 10012, '코튼 와플 반팔티', 9900, 4, NOW(), NOW()),
    (10006, 10004, 10008, '레더 미니멀 크로스백', 128000, 1, NOW(), NOW()),
    (10007, 10005, 10004, '워시드 와이드 데님 팬츠', 68000, 1, NOW(), NOW());
...
INSERT INTO point_transactions (
    ...
    created_at
      ...
      (10001, 10001, 10001, NULL,  'USE',         1000, NOW()),
      (10002, 10001, 10001, NULL,  'EARN',         770, NOW()),
